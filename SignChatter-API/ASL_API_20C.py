...
def loadModel():
    ...
    model.load_weights(r'/root/final_year_project/Mediapipe-API-PSL/20C_50F_128B_20T_sorted_55A_A3_30D.h5')
    return model
...
#            cv2.imwrite('final.jpg',finalFrame)
...
async def predict_action(file: UploadFile = File()):
    video_path = f"/root/final_year_project/Mediapipe-API-PSL/videos3/{file.filename}"
